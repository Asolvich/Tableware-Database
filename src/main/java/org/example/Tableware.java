...
public class Tableware {
    ...
    private String name;// Название посуды
    private String material;// Материал, из которого изготовлена посуда
    private String type;// Тип посуды (например, "кружка", "тарелка")
    private Integer volumeMl; // Объем посуды в миллилитрах
    private Integer priceRub; // Цена посуды в рублях
