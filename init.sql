...
CREATE TABLE IF NOT EXISTS tableware (
    ...
    name VARCHAR(255) NOT NULL UNIQUE,  -- Название посуды (уникальное и не может быть пустым)
    material VARCHAR(100) NOT NULL UNIQUE, -- Материал (уникальное и не может быть пустым)
